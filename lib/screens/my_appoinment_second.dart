...
import 'my_appoinment_confirmation.dart';

class MyAppoinmentSecond extends StatelessWidget {
  const MyAppoinmentSecond({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          InkWell(
            onTap: (() {
              push(context: context, widget: MyAppoinMentConfirmation());
            }),
            child: Container(
              height: 130,
